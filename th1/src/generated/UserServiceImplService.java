 ...
 * 
 */
@WebServiceClient(name = "UserServiceImplService", targetNamespace = "http://server.webservice/", wsdlLocation = "http://localhost:8080/ws/users?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERSERVICEIMPLSERVICE_QNAME = new QName("http://server.webservice/", "UserServiceImplService");
