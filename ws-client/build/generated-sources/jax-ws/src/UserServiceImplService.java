 ...
 * 
 */
@WebServiceClient(name = "UserServiceImplService", targetNamespace = "http://src/", wsdlLocation = "http://localhost:8080/ws/users?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERSERVICEIMPLSERVICE_QNAME = new QName("http://src/", "UserServiceImplService");
    ...
    public UserService getUserServiceImplPort() {
        return super.getPort(new QName("http://src/", "UserServiceImplPort"), UserService.class);
    }
    ...
    public UserService getUserServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://src/", "UserServiceImplPort"), UserService.class, features);
    }
